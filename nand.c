...
int nand_init (at91_t *at91)
{
    ...
    writel((AT91C_SMC_READMODE | AT91C_SMC_WRITEMODE | AT91C_SMC_NWAITM_NWAIT_DISABLE |
                AT91C_SMC_DBW_WIDTH_EIGHT_BITS | AT91C_SM_TDF), AT91C_BASE_SMC + SMC_CTRL3);
    ...
    writel((readl(AT91C_BASE_SMC + SMC_CTRL3) & ~(AT91C_SMC_DBW)) | AT91C_SMC_DBW_WIDTH_EIGHT_BITS, AT91C_BASE_SMC + SMC_CTRL3);
